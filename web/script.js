...
const i18n = {
    ...
    es: {
        ...
        desc_pizza: "Masa especialmente fermentada, salsa de tomate italiana y exquisito queso mozzarella horneados en horno de leña.",
    ...
    it: {
        ...
        cat_food: "Hot from the Oven",
        cat_drinks: "Beverages & Desserts",
        item_pizza: "Pizza Cotta a Pietra",
        desc_pizza: "Impasto a lievitazione speciale, salsa di pomodoro italiano e squisita mozzarella cotta nel forno a legna.",
        item_menemen: "Famoso Menemen",
        desc_menemen: "Preparato solo con tuorli d'uovo, tanto formaggio cheddar e burro, un sapore leggendario della colazione regionale.",
        item_toast: "Baked Bazlama Toast",
        desc_toast: "Served crispy from the stone oven with cheddar cheese and special sausage/beef between village bread.",
        item_coffee: "Special Turkish Coffee",
        desc_coffee: "Finely roasted and ground premium fresh Arabica coffee, expertly brewed and served with famous Turkish delight.",
