...
const i18n = {
    tr: {
        tourist_loc_badge: "📍 Galata'nın Kalbinde",
        tourist_title: "Galata Kulesi'nden Sadece 3 Dakika!",
        tourist_desc: "Tarihi Galata Kulesi ve İstiklal Caddesi geziniz öncesinde veya sonrasında; 150 yıllık tarihi binamızda meşhur Çakallı menemeni, zengin serpme Türk kahvaltısı ve odun ateşinde taş fırın Napoliten pizza için en yakın otantik mola noktası.",
        tourist_guide_link: "Akıllı Şehir Rotası",
        tourist_dist_galata: "350m • 4 dk yürüme",
        tourist_dist_sishane: "250m • 3 dk yürüme",
        tourist_dist_istiklal: "200m • 2.5 dk yürüme",
        tourist_dist_karakoy: "600m • 8 dk yokuş aşağı",
        tourist_badge_outlets: "⚡ Masalarda Priz & Şarj",
        tourist_badge_luggage: "🧳 Sırt Çantası & Bavul Dostu",
    ...
    en: {
        tourist_loc_badge: "📍 In the Heart of Galata",
        tourist_title: "Only 3 Minutes from Galata Tower!",
        tourist_desc: "Before or after visiting the historic Galata Tower & Istiklal Street, unwind in our 150-year-old historic stone building. Savor authentic Çakallı menemen, rich traditional Turkish breakfast spreads, and wood-fired Neapolitan pizza.",
        tourist_guide_link: "Smart City Route",
        tourist_dist_galata: "350m • 4 min walk",
        tourist_dist_sishane: "250m • 3 min walk",
        tourist_dist_istiklal: "200m • 2.5 min walk",
        tourist_dist_karakoy: "600m • 8 min downhill",
        tourist_badge_outlets: "⚡ Power Outlets & Charging",
        tourist_badge_luggage: "🧳 Backpack & Luggage Friendly",

        cat_1: "Menemen",
        cat_2: "Omelette",
        cat_3: "Toast (Bazlama Toast)",
        cat_4: "Pizza",
        cat_5: "Hot Drinks",
        cat_6: "Cold Drinks",
        cat_7: "Dessert/Sweet",
    ...
    es: {
        tourist_loc_badge: "📍 En el Corazón de Gálata",
        tourist_title: "¡A Solo 3 Minutos de la Torre de Gálata!",
        tourist_desc: "Antes o después de visitar la Torre de Gálata y la Calle Istiklal, descanse en nuestro edificio histórico de 150 años. Disfrute del auténtico menemen Çakallı, desayuno tradicional turco y pizza napolitana al horno de leña.",
        tourist_guide_link: "Ruta de la Ciudad",
        tourist_dist_galata: "350m • 4 min a pie",
        tourist_dist_sishane: "250m • 3 min a pie",
        tourist_dist_istiklal: "200m • 2.5 min a pie",
        tourist_dist_karakoy: "600m • 8 min cuesta abajo",
        tourist_badge_outlets: "⚡ Enchufes y Carga en Mesas",
        tourist_badge_luggage: "🧳 Apto para Mochilas y Maletas",

        cat_1: "Menemen",
        cat_2: "Omelette",
        cat_3: "Tostada (Tostada Bazlama)",
        cat_4: "Pizza",
        cat_5: "Bebidas Calientes",
        cat_6: "Bebidas Frías",
        cat_7: "Postre/Dulce",
        tag_vegan: "Vegano",
        tag_gluten: "Gluten",
    ...
    ru: {
        tourist_loc_badge: "📍 В самом сердце Галаты",
        tourist_title: "Всего 3 минуты от башни Галата!",
        tourist_desc: "До или после прогулки к башне Галата и улице Истикляль отдохните в нашем историческом здании с 150-летней историей. Попробуйте знаменитый менемен Чакаллы, традиционный турецкий завтрак и неаполитанскую пиццу из дровяной печи.",
        tourist_guide_link: "Умный городской маршрут",
        tourist_dist_galata: "350м • 4 мин пешком",
        tourist_dist_sishane: "250м • 3 мин пешком",
        tourist_dist_istiklal: "200м • 2.5 мин пешком",
        tourist_dist_karakoy: "600м • 8 мин под горку",
        tourist_badge_outlets: "⚡ Розетки и зарядка у столов",
        tourist_badge_luggage: "🧳 Удобно с рюкзаками и багажом",

        cat_1: "Menemen",
        cat_2: "Омлет",
        cat_3: "Тост (Базлама тост)",
        cat_4: "Пицца",
        cat_5: "Горячие напитки",
        cat_6: "Холодные напитки",
        cat_7: "Десерт/Сладкое",
        tag_vegan: "Веганский",
        tag_gluten: "Глютен",
        tag_gluten_free: "Без глютена",
        tag_halal: "Халяль",
        tag_dairy: "Молочные продукты (Казеин)",
        tag_vegetarian: "Вегетарианский",
    ...
    hi: {
        tourist_loc_badge: "📍 गालाटा के केंद्र में",
        tourist_title: "गालाटा टॉवर से केवल 3 मिनट दूर!",
        tourist_desc: "ऐतिहासिक गालाटा टॉवर और इस्तिकलाल स्ट्रीट घूमने से पहले या बाद में, हमारी 150 साल पुरानी इमारत में आराम करें। प्रसिद्ध चाकल्ली मेनेमेन, प्रामाणिक तुर्की नाश्ता और लकड़ी की भट्टी में बने नियतिन पिज्जा का आनंद लें।",
        tourist_guide_link: "स्मार्ट सिटी रूट",
        tourist_dist_galata: "350 मी • 4 मिनट पैदल",
        tourist_dist_sishane: "250 मी • 3 मिनट पैदल",
        tourist_dist_istiklal: "200 मी • 2.5 मिनट पैदल",
        tourist_dist_karakoy: "600 मी • 8 मिनट ढलान पर",
        tourist_badge_outlets: "⚡ टेबल पर चार्जिंग सॉकेट",
        tourist_badge_luggage: "🧳 बैग और सूटकेस के लिए उपयुक्त",

        cat_1: "Menemen",
        cat_2: "आमलेट",
        cat_3: "टोस्ट (बज़लामा टोस्ट)",
        cat_4: "पिज़्ज़ा",
        cat_5: "गर्म पेय",
        cat_6: "ठंडे पेय",
        cat_7: "मिठाई",
        tag_vegan: "वीगन",
        tag_gluten: "ग्लूटेन",
        tag_gluten_free: "ग्लूटेन फ्री",
        tag_halal: "हलाल",
        tag_dairy: "डेयरी (केसीन)",
        tag_vegetarian: "शाकाहारी",
        category: "कैफ़े और रेस्तरां",
        status_open: "अभी खोलें (08:00 - 23:00)",
        btn_menu: "📖डिजिटल मेनू देखें",
        btn_gezi: "🗺️ इस्तांबुल यात्रा गाइड और मार्ग",
        btn_reserve: "एक मेज़ बुक करो",
        btn_message: "हमें एक संदेश भेजें",
        title_about: "हमारे बारे में",
        slogan_about: "पारंपरिक स्वाद, अद्वितीय व्यंजन केवल फ़िरिन्ना में",
        text_about: "प्रिय अतिथि, फ़िरिन्ना में आपका स्वागत है।\n\nगैलाटा के 150 साल पुराने ऐतिहासिक माहौल में, शांतिपूर्ण कुम्बारासी योकुसु पर स्थित, फ़िरिन्ना कैफे और रेस्तरां एक विशेष पाक आश्रय है जहां आप इस्तिकलाल स्ट्रीट की हलचल से दूर जा सकते हैं और ताज़ा सांस ले सकते हैं।\n\nसावधानीपूर्वक चयनित सामग्री, ताजा ओवन-बेक्ड विशिष्टताओं, समृद्ध कॉफी किस्मों और घर का बना के साथ मिठाइयाँ, हम पारंपरिक व्यंजनों को आधुनिक स्पर्श के साथ जीवंत करते हैं।\n\nयहाँ कोई भीड़ नहीं है! हमारी मिलनसार, मेहमाननवाज़ और पालतू-मैत्रीपूर्ण टीम के साथ, हमारी 150 साल पुरानी ऐतिहासिक इमारत के माहौल में गर्मजोशी भरी बातचीत और शांतिपूर्ण क्षणों का आनंद लें। इस्तांबुल की आपकी ऐतिहासिक यात्रा को मधुर स्मृति में पाकर हमें प्रसन्नता होगी।",
        title_top_reviews: "हमारे ग्राहकों से",
        title_gating: "अपने अनुभव को रेटिंग दें",
        sub_gating: "फ़िरिन्ना में आपका अनुभव कैसा था? आपकी प्रतिक्रिया हमारे लिए बहुत मायने रखती है।",
        gating_high_msg: "🎉 अद्भुत! हमें ख़ुशी है कि आपने इसका आनंद लिया। क्या आप इन प्लेटफार्मों पर 5-सितारा समीक्षा के साथ हमारा समर्थन करना चाहेंगे?",
        gating_low_title: "आपकी प्रतिक्रिया हमारे लिए बहुत मूल्यवान है!",
        gating_low_msg: "आप कोई भी प्रतिक्रिया या समस्या सीधे हमारे प्रबंधक को भेज सकते हैं:",
        btn_google_review: "Google पर 5 स्टार रेटिंग दें",
        btn_yandex_review: "यांडेक्स पर रेट करें",
        btn_tripadvisor_review: "ट्रिपएडवाइजर पर समीक्षा करें",
        google_perfect: "गूगल पर उत्कृष्ट",
        yandex_perfect: "यांडेक्स पर उत्कृष्ट",
        btn_inspect: "समीक्षा",
        btn_see_all_google_photos: "Google मानचित्र पर सभी फ़ोटो देखें (100+)",
        table_available: "वर्तमान में {एन} टेबल उपलब्ध हैं, स्वागत है!",
        table_full: "फिलहाल सभी टेबलें भरी हुई हैं।",
        table_offline: "तालिका स्थिति अनुपलब्ध.",
        text_group_events: "<strong>समूह और निजी कार्यक्रम:</strong> बाद के घंटों की समूह बुकिंग और छोटे कार्यक्रमों के लिए, कृपया <a href='https://wa.me/905456301214?text=Hello,%20I%20would%20like%20information%20about%20group%20bookings.' लक्ष्य='_रिक्त' शैली='रंग:#059669; फ़ॉन्ट-वजन:700; टेक्स्ट-डेकोरेशन:अंडरलाइन;'>व्हाट्सएप के माध्यम से संपर्क करें</a>।",
        review_1: "इस्तिकलाल के शोर से बचने और सांस लेने के लिए एक अद्भुत, ऐतिहासिक जगह। उनके पिज़्ज़ा प्रसिद्ध हैं!",
        review_2: "आपको मेनमेन जरूर आज़माना चाहिए। स्टाफ़ बहुत मुस्कुरा रहा है और यह बहुत अच्छी बात है कि वे पालतू जानवरों के प्रति दोस्ताना व्यवहार रखते हैं।",
        review_3: "कॉफ़ी और मिठाइयों के लिए गलाटा में सबसे अच्छी जगह। स्टाफ बहुत चौकस है.",
        title_virtual_tour: "आभासी यात्रा (360°)",
        text_virtual_tour: "जहां आप बैठे हैं, वहीं से हमारी 150 साल पुरानी ऐतिहासिक इमारत का अन्वेषण करें।",
        title_faq: "अक्सर पूछे जाने वाले प्रश्नों",
        faq_q1: "🐾 क्या पालतू जानवरों की अनुमति है?",
        faq_a1: "हाँ! फ़िरिन्ना 100% पालतू-अनुकूल है। हमारे आउटडोर गार्डन और इनडोर सीटिंग दोनों में अपने प्यारे दोस्तों के साथ अपने समय का आनंद लेने के लिए आपका स्वागत है।",
        faq_q2: "💳 आप कौन सी भुगतान विधियाँ स्वीकार करते हैं?",
        faq_a2: "हम सभी प्रमुख क्रेडिट कार्ड, डेबिट कार्ड, संपर्क रहित मोबाइल भुगतान (एप्पल पे / गूगल पे) और नकद स्वीकार करते हैं।",
        faq_q3: "🥗 क्या आपके पास शाकाहारी या ग्लूटेन-मुक्त विकल्प हैं?",
        faq_a3: "हाँ! हमारा मेनू स्वादिष्ट शाकाहारी स्टोन-ओवन पिज्जा, भरपूर नाश्ता स्प्रेड और ग्लूटेन-मुक्त/शाकाहारी विकल्प प्रदान करता है।",
        faq_q4: "🕒 क्या हम समूह आरक्षण या निजी कार्यक्रम कर सकते हैं?",
        faq_a4: "हाँ! जन्मदिन, कॉर्पोरेट मीटिंग या निजी छोटे कार्यक्रमों के लिए, बेझिझक सीधे व्हाट्सएप के माध्यम से हमसे संपर्क करें।",
        title_location: "जगह",
        title_contact: "संपर्क एवं स्थान",
        title_gallery: "माहौल और स्वाद",
        gal_title_interior: "इनडोर और माहौल",
        gal_title_exterior: "आउटडोर और कुम्बारासी स्ट्रीट",
        gal_title_signature: "हमारा सिग्नेचर स्वाद",
        gal_lbl_interior_history: "ऐतिहासिक आंतरिक भाग",
        gal_lbl_warm_tables: "आरामदायक बैठने की जगह",
        gal_lbl_details: "स्थल विवरण",
        gal_lbl_street: "कुम्बारासी स्ट्रीट",
        gal_lbl_outdoor_seating: "घर के बाहर बैठने",
        gal_lbl_historic_building: "ऐतिहासिक इमारत",
        gal_lbl_fresh_tea: "ताज़ा तुर्की चाय",
        gal_lbl_turkish_coffee: "तुर्की कॉफ़ी",
        gal_lbl_menemen: "स्किललेट मेनमेन",
        gal_lbl_pizza: "स्टोन ओवन पिज्जा",
        gal_lbl_lemonade: "घर का बना नींबू पानी",
        gal_lbl_glintwein: "चीनी और मसालों के साथ गर्म की गई शराब",
        badge_historic_tr: "ऐतिहासिक तुर्की कैफे",
        badge_halal: "100% हलाल",
        badge_quality: "अच्छी गुणवत्ता",
        badge_price: "उचित मूल्य",
        title_reviews: "स्थान और हाल की समीक्षाएँ",
        btn_google: "हाल की Google समीक्षाएँ पढ़ें",
        btn_yandex: "यांडेक्स मानचित्र पर देखें",
        btn_baidu: "Baidu मानचित्र पर देखें",
        modal_res_title: "टेबल आरक्षण",
        label_name: "पूरा नाम",
        label_phone: "फ़ोन नंबर",
        label_date: "तारीख",
        label_time: "समय (08:00-23:00)",
        label_guests: "मेहमानों की संख्या",
        label_note: "विशेष अनुरोध/नोट (वैकल्पिक)",
        btn_submit: "अनुरोध भेजा",
        modal_msg_title: "हमें एक संदेश भेजें",
        label_message: "आपका संदेश",
        btn_submit_msg: "मेसेज भेजें",
        footer_rights: "सर्वाधिकार सुरक्षित।",
        menu_header_title: "हस्ताक्षर स्वाद",
        menu_header_sub: "फ़िरिन्ना के स्पर्श से...",
        menu_back: "घर",
        menu_intro: "आप हमारे स्टोर पर जा सकते हैं या सभी मेनू विकल्पों के लिए हमारे स्टाफ से विस्तृत जानकारी प्राप्त कर सकते हैं। नीचे आप हमारे सबसे पसंदीदा स्वादों की समीक्षा कर सकते हैं।",
        menu_download: "मूल्य मेनू डाउनलोड करें (पीडीएफ)",
        desc_t1: "ओवन से निकाला गया ताज़ा हॉट चॉकलेट केक, जिसके ऊपर प्रसिद्ध मरास आइसक्रीम, चॉकलेट सॉस और थोड़ा सा नारियल डाला गया है।",
        p_t1: "आइसक्रीम के साथ हॉट चॉकलेट केक",
        desc_c3: "बर्फ जैसे ठंडे नींबू पानी के आधार पर दालचीनी, हिबिस्कस और ईरानी केसर के अनूठे संयोजन से तैयार एक ताज़ा विशेष औषधि।",
        p_c3: "हिबिस्कस केसर नींबू पानी",
        desc_c2: "प्राकृतिक खनिज पानी.",
        p_c2: "मिनरल वॉटर",
        desc_c1: "ताज़ा पानी.",
        p_c1: "पानी",
        desc_s5: "दूध के झाग के साथ इतालवी क्लासिक।",
        p_s5: "कैपुचिनो",
        desc_s4: "भरपूर दूध के साथ एस्प्रेसो।",
        p_s4: "लाटे",
        desc_s3: "ताज़ी पिसी हुई फलियों से बनी कड़क कॉफ़ी।",
        p_s3: "americano",
        desc_s2: "पारंपरिक तुर्की कॉफी, धीमी गति से पकी हुई, बहुत झागदार, तुर्की आनंद के साथ परोसी गई।",
        p_s2: "तुर्की कॉफ़ी",
        desc_s1: "बरगामोट के स्वाद वाली और सूखी गुलाब की पंखुड़ियों से नरम की गई सावधानी से चुनी गई चाय की पत्तियों का एक विशेष मिश्रण।",
        p_s1: "विशेष मिश्रण चाय",
        desc_p3: "बीफ़ डोनर, चिकन डोनर, सॉसेज और ढेर सारे मोज़ेरेला के साथ पकाया गया शानदार फेस्टिवल पिज़्ज़ा।",
        p_p3: "पूर्ण मिश्रित दावत पिज़्ज़ा",
        desc_p2: "मार्गेरिटा बेस पर आपका विशेष स्वाद: विशेष मैरीनेट किया हुआ बीफ़ डोनर, चिकन डोनर, या सॉसेज।",
        p_p2: "प्रोटीन पिज्जा",
        desc_p1: "पत्थर के ओवन में पकाया गया असली नियति शैली का आटा, हमारा विशेष मिश्रण पिज़्ज़ा सॉस और ताज़ा मोज़ेरेला।",
        p_p1: "पिज़्ज़ा मार्गेरिटा",
        desc_b3: "एक हार्दिक और त्वरित क्लासिक! कुरकुरी बाज़लामा ब्रेड में आपके दो चुने हुए प्रोटीन का गर्म मिलन।",
        p_b3: "मिश्रित बज़लामा टोस्ट",
        desc_b2: "पिघले हुए पनीर के साथ-साथ आपके चुने हुए प्रोटीन से भरपूर टोस्ट।",
        p_b2: "प्रोटीन बज़लामा",
        desc_b1: "पारंपरिक टर्किश विलेज ब्रेड टोस्ट, बाहर से कुरकुरा, पिघलते पनीर से भरा हुआ।",
        p_b1: "पारंपरिक बज़लामा टोस्ट",
        desc_o4: "आपकी पसंद के दो स्वादों के साथ सिर्फ आपके लिए बनाया गया एक विशाल आमलेट।",
        p_o4: "मिश्रित दावत आमलेट",
        desc_o3: "Filling omelette with your choice of Beef Döner, Chicken Döner, or Traditional Sausage.",
        p_o3: "विशेष प्रोटीन आमलेट",
        desc_o2: "पिघलते पनीर से भरा आमलेट।",
        p_o2: "पनीर के साथ आमलेट",
        desc_o1: "नरम क्लासिक आमलेट एक पैन में सावधानी से पकाया गया।",
        p_o1: "पारंपरिक पान आमलेट",
        desc_m4: "हॉट मेनमेन के साथ आपके दो चुने हुए प्रोटीन की पौराणिक मुलाकात।",
        p_m4: "मिश्रित पर्व मेनमेन",
        desc_m3: "पारंपरिक मेनमेन बेस आपकी पसंद के विशेष रूप से मैरीनेट किए गए कटा हुआ बीफ़ डोनर, चिकन डोनर, या सॉसेज के साथ सबसे ऊपर है।",
        p_m3: "बीफ/सॉसेज/चिकन के साथ मेनमेन",
        desc_m2: "अतिरिक्त पनीर के साथ प्रतिष्ठित तुर्की मेनमेन।",
        p_m2: "पनीर के साथ मेनमेन",
        desc_m1: "कुचले हुए टमाटरों और पिघले हुए पनीर से तैयार प्रतिष्ठित तुर्की नाश्ता।",
        p_m1: "पारंपरिक मेनमेन",
        cat_food: "ओवन से गर्म",
        cat_drinks: "पेय पदार्थ और मिठाइयाँ",
        item_pizza: "Stone-baked Pizza",
        desc_pizza: "विशेष रूप से किण्वित आटा, इटालियन टमाटर सॉस, और लकड़ी से बने ओवन में पकाया गया उत्तम मोज़ेरेला चीज़।",
        item_menemen: "प्रसिद्ध मेनमेन",
        desc_menemen: "केवल अंडे की जर्दी, भरपूर मात्रा में चेडर और मक्खन के साथ तैयार, एक प्रसिद्ध क्षेत्रीय नाश्ते का स्वाद।",
        item_toast: "Baked Bazlama Toast",
        desc_toast: "गांव की ब्रेड के बीच चेडर चीज़ और विशेष सॉसेज/बीफ के साथ स्टोन ओवन से कुरकुरा परोसा गया।",
        item_coffee: "विशेष तुर्की कॉफ़ी",
        desc_coffee: "बारीक भुनी हुई और पिसी हुई प्रीमियम ताज़ी अरेबिका कॉफ़ी, विशेषज्ञ रूप से बनाई गई और प्रसिद्ध तुर्की आनंद के साथ परोसी गई।",
        item_tea: "गुलाब की कली मिश्रित चाय",
        desc_tea: "तुर्की और सीलोन चाय, बरगामोट और सूखे गुलाब की कलियों के प्रीमियम मिश्रण से बनाया गया।",
        item_lemonade: "विशेष घर का बना नींबू पानी",
        desc_lemonade: "हिबिस्कस, दालचीनी, स्टार ऐनीज़ और प्रामाणिक फ़ारसी केसर से युक्त बर्फ जैसा ठंडा घर का बना ताज़ा नींबू पानी।",
        item_cake: "चॉकलेट सॉस के साथ हॉट चॉकलेट केक",
        desc_cake: "अंदर से नरम, ढेर सारा कोको, और गर्म चॉकलेट सॉस से ढका हुआ, एक अपरिहार्य स्वाद।",
        badge_veg: "शाकाहारी",
        badge_vegan: "शाकाहारी",
        badge_gluten: "ग्लूटेन शामिल है",
        badge_dairy: "डेयरी शामिल है",
        title_work_hours: "कार्य दिवस और घंटे",
        status_now_open: "🟢अभी खोलें",
        status_now_closed: "🔴 अब बंद",
        signature_intro: "हमारे सबसे पसंदीदा, सावधानी से चुने गए स्वाद। किसी भी आइटम का मेनू विवरण देखने के लिए उस पर क्लिक करें।",
        signature_loading: "सिग्नेचर फ़्लेवर लोड हो रहा है...",
        title_location_yandex: "स्थान एवं दिशा-निर्देश (यांडेक्स मानचित्र)",
        badge_live_traffic: "🔴 लाइव ट्रैफ़िक और 3डी इमारतें",
        address_full: "<strong>पता:</strong> सहकुलु मह. कुम्बारासी योकुसु सोक। नंबर:41ए, 34421 बेयोग्लू/इस्तांबुल (इस्तिकलाल स्ट्रीट और गलाटा टॉवर के पास)",
        btn_yandex_nav: "यांडेक्स नेविगेशन",
        btn_panorama: "360° कुम्बारासी स्ट्रीट पैनोरमा",
        title_social_media: "सोशल मीडिया पर क्या लोकप्रिय है?",
        badge_tour_videos: "🎬 यात्रा और तैयारी वीडियो",
        title_amenities: "स्थल की विशेषताएँ एवं सुविधाएँ",
        amenity_pet: "🐾 पालतू-मैत्रीपूर्ण",
        amenity_halal: "🕌 100% हलाल भोजन",
        amenity_wifi: "📶 निःशुल्क हाई-स्पीड वाई-फाई",
        amenity_oven: "🍕 पारंपरिक स्टोन ओवन",
        amenity_historic: "🏛️ 150 साल का ऐतिहासिक माहौल",
        amenity_nfc: "💳 संपर्क रहित/एनएफसी भुगतान",
        amenity_veg: "🌿 शाकाहारी विकल्प",
        amenity_gluten: "🌾 ग्लूटेन-मुक्त/स्वस्थ विकल्प",
        amenity_family: "👶 परिवार एवं बच्चों के अनुकूल",
        amenity_tea: "☕ स्पेशल रोज़बड ब्लेंड चाय",
        google_review_desc: "सभी वास्तविक अतिथि समीक्षाएँ और रेटिंग सीधे Google पर देखें।",
        yandex_review_desc: "यांडेक्स मानचित्र पर स्थान देखें और रिकॉर्ड की समीक्षा करें।",
        badge_satisfaction: "ग्राहक संतुष्टि",
        title_social: "सामाजिक जिम्मेदारी",
        social_intro: "फ़िरिन्ना कैफे के रूप में, हम अपनी कमाई और प्यार अपने पड़ोस के साथ साझा करते हैं।",
        social_student_title: "बेयोग्लू में छात्र परियोजना",
        social_student_desc: "हम बेयोग्लू में विश्वविद्यालय के छात्रों को निःशुल्क भोजन प्रदान करने में सहायता करते हैं।",
        social_animal_title: "स्ट्रीट एनिमल्स फ्रेंडली",
        social_animal_desc: "हम हर दिन अपनी सड़क पर अपने प्यारे दोस्तों के लिए भोजन और पानी उपलब्ध कराते हैं।",
        search_placeholder: "🔍मेनू खोजें...",
        filter_all: "✨ सभी मेनू",
        filter_halal: "☪️ 100% हलाल",
        filter_veggie: "🌿 शाकाहारी",
        filter_glutenfree: "🌾 ग्लूटेन-मुक्त",
        filter_signature: "⭐ हस्ताक्षर",
        badge_stone_oven: "🍕 स्टोन ओवन",
        title_pizza_napo: "नियपोलिटन पिज्जा",
        badge_famous: "🍳 प्रसिद्ध",
        title_menemen_cakal: "इस्तांबुल",
        badge_traditional: "☕ पारंपरिक",
        title_coffee: "तुर्की कॉफ़ी",
        whatsapp_manager: "व्हाट्सएप प्रबंधक",
        btn_send_msg2: "मेसेज भेजें",
        filter_dairyfree: "🚫 डेयरी मुक्त",
        p_c4: "आइस्ड अमेरिकनो",
        desc_c4: "आइस्ड एस्प्रेसो और पानी का ताज़ा संयोजन, एक विशेष कोको कुकी के साथ परोसा गया।",
        p_c5: "आइस्ड लट्टे",
        desc_c5: "ताजा आइस्ड दूध और एस्प्रेसो का ठंडा सामंजस्य, एक विशेष कोको कुकी के साथ परोसा गया।",
    },

    ar: {
        tourist_loc_badge: "📍 في قلب غلطة",
        tourist_title: "على بُعد 3 دقائق فقط من برج غلطة!",
        tourist_desc: "قبل أو بعد زيارة برج غلطة التاريخي وشارع الاستقلال، استمتع في مبنانا التاريخي العريق البالغ من العمر 150 عاماً بألذ مفرومة شكشوكة (مينيمين تشاكاللي)، والفطور التركي التقليدي الفاخر، وبيتزا نابولي في الفرن الحجري.",
        tourist_guide_link: "خريطة الجولة السياحية",
        tourist_dist_galata: "350م • 4 دقائق مشياً",
        tourist_dist_sishane: "250م • 3 دقائق مشياً",
        tourist_dist_istiklal: "200م • 2.5 دقيقة مشياً",
        tourist_dist_karakoy: "600م • 8 دقائق نزولاً",
        tourist_badge_outlets: "⚡ مقابس كهرباء وشحن على الطاولات",
        tourist_badge_luggage: "🧳 مناسب لحقائب السفر وحقائب الظهر",

        cat_1: "Menemen",
        cat_2: "أومليت",
        cat_3: "توست (توست بازلاما)",
        cat_4: "بيتزا",
        cat_5: "مشروبات ساخنة",
        cat_6: "مشروبات باردة",
        cat_7: "حلويات",
        tag_vegan: "نباتي صرف",
        tag_gluten: "غلوتين",
        tag_gluten_free: "خالي من الغلوتين",
        tag_halal: "حلال",
        tag_dairy: "منتجات الألبان (الكازين)",
    ...
    zh: {
        tourist_loc_badge: "📍 位于加拉达核心区",
        tourist_title: "距离加拉达石塔仅3分钟！",
        tourist_desc: "在游览历史悠久的加拉达塔与独立大街前后，欢迎来到我们拥有150年历史的古建筑内小憩。品尝地道的恰卡勒番茄炒蛋（Çakallı Menemen）、丰盛的土耳其传统早餐以及正宗柴火石炉拿坡里披萨。",
        tourist_guide_link: "智能城市漫步路线",
        tourist_dist_galata: "350米 • 步行4分钟",
        tourist_dist_sishane: "250米 • 步行3分钟",
        tourist_dist_istiklal: "200米 • 步行2.5分钟",
        tourist_dist_karakoy: "600米 • 下坡步行8分钟",
        tourist_badge_outlets: "⚡ 餐桌配备充电插座",
        tourist_badge_luggage: "🧳 行李箱与背包友好",
    ...
    uk: {
        tourist_loc_badge: "📍 У самому серці Ґалати",
        tourist_title: "Лише 3 хвилини від вежі Ґалата!",
        tourist_desc: "До чи після прогулянки вежею Ґалата та вулицею Істікляль завітайте до нашої 150-річної історичної будівлі. Скуштуйте легендарний менемен Чакалли, традиційний турецький сніданок та неаполітанську піцу з дров'яної печі.",
        tourist_guide_link: "Розумний маршрут містом",
        tourist_dist_galata: "350м • 4 хв пішки",
        tourist_dist_sishane: "250м • 3 хв пішки",
        tourist_dist_istiklal: "200м • 2.5 хв пішки",
        tourist_dist_karakoy: "600м • 8 хв схилом униз",
        tourist_badge_outlets: "⚡ Розетки та зарядка біля столиків",
        tourist_badge_luggage: "🧳 Зручно з валізами та рюкзаками",
        ...
        text_group_events: "<strong>Групові та приватні заходи:</strong> для групових бронювань у неробочий час і міні-подій, будь ласка, <a href='https://wa.me/905456301214?text=Hello,%20I%20would%20like%20information%20about%20group%20bookings.' target='_blank' style='color:#059669; товщина шрифту:700; text-decoration:underline;'>Зв'язатися через WhatsApp</a>.",
        ...
        address_full: "<strong>Адреса:</strong> Şahkulu Mah. Kumbaracı Yokuşu Sok. No:41A, 34421 Beyoğlu/İstanbul (Біля вулиці Істікляль і вежі Галата)",
        ...
        tag_halal: "халяль",
        tag_dairy: "Молочні продукти (казеїн)",
    ...
    de: {
        tourist_loc_badge: "📍 Im Herzen von Galata",
        tourist_title: "Nur 3 Minuten vom Galataturm entfernt!",
        tourist_desc: "Vor oder nach dem Besuch des Galataturms und der Istiklal-Straße entspannen Sie in unserem 150 Jahre alten historischen Steingebäude. Genießen Sie authentisches Çakallı Menemen, traditionelles türkisches Frühstück und neapolitanische Steinofenpizza.",
        tourist_guide_link: "Smarte City-Route",
        tourist_dist_galata: "350m • 4 Min. zu Fuß",
        tourist_dist_sishane: "250m • 3 Min. zu Fuß",
        tourist_dist_istiklal: "200m • 2.5 Min. zu Fuß",
        tourist_dist_karakoy: "600m • 8 Min. bergab",
        tourist_badge_outlets: "⚡ Steckdosen an den Tischen",
        tourist_badge_luggage: "🧳 Koffer- & Rucksack-freundlich",
        ...
        text_group_events: "<strong>Gruppen- und Privatveranstaltungen:</strong> Für Gruppenbuchungen und Miniveranstaltungen außerhalb der Geschäftszeiten wenden Sie sich bitte an <a href='https://wa.me/905456301214?text=Hello,%20I%20would%20like%20information%20about%20group%20bookings.' target='_blank' style='color:#059669; Schriftstärke:700; text-decoration:underline;'>Kontakt über WhatsApp</a>.",
        ...
        address_full: "<strong>Adresse:</strong> Şahkulu Mah. Kumbaracı Yokuşu Sok. No:41A, 34421 Beyoğlu/İstanbul (in der Nähe der Istiklal-Straße und des Galata-Turms)",
        btn_yandex_nav: "Yandex-Navigation",
        ...
        tag_halal: "Halal",
        tag_dairy: "Milchprodukte (Kasein)",
    ...
    fr: {
        tourist_loc_badge: "📍 Au Cœur de Galata",
        tourist_title: "À seulement 3 minutes de la Tour de Galata !",
        tourist_desc: "Avant ou après votre visite de la Tour de Galata et de la rue Istiklal, faites une pause dans notre bâtiment historique de 150 ans. Dégustez le fameux menemen de Çakallı, un authentique petit-déjeuner turc et une pizza napolitaine au feu de bois.",
        tourist_guide_link: "Itinéraire Intelligent",
        tourist_dist_galata: "350m • 4 min à pied",
        tourist_dist_sishane: "250m • 3 min à pied",
        tourist_dist_istiklal: "200m • 2.5 min à pied",
        tourist_dist_karakoy: "600m • 8 min en descente",
        tourist_badge_outlets: "⚡ Prises et recharge aux tables",
        tourist_badge_luggage: "🧳 Idéal pour sacs à dos et valises",
        ...
        text_group_events: "<strong>Événements de groupe et privés :</strong> pour les réservations de groupe et les mini-événements en dehors des heures d'ouverture, veuillez <a href='https://wa.me/905456301214?text=Hello,%20I%20would%20like%20information%20about%20group%20bookings.' target='_blank' style='color:#059669; poids de la police : 700 ; text-decoration:underline;'>Contact via WhatsApp</a>.",
        ...
        address_full: "<strong>Adresse :</strong> Şahkulu Mah. Kumbaracı Yokuşu Sok. No : 41A, 34421 Beyoğlu/Istanbul (près de la rue Istiklal et de la tour de Galata)",
        ...
        tag_halal: "halal",
        tag_dairy: "Produits laitiers (caséine)",
    ...
    fa: {
        tourist_loc_badge: "📍 در قلب منطقه گالاتا",
        tourist_title: "فقط ۳ دقیقه فاصله تا برج گالاتا!",
        tourist_desc: "قبل یا بعد از گشت‌وگذار در برج گالاتا و خیابان استقلال، در ساختمان تاریخی ۱۵۰ ساله ما استراحت کنید. منمن اصیل چاکالی، صبحانه سنتی ترکی و پیتزای تنوری ناپلی را امتحان کنید.",
        tourist_guide_link: "مسیر هوشمند گردشگری",
        tourist_dist_galata: "۳۵۰ متر • ۴ دقیقه پیاده",
        tourist_dist_sishane: "۲۵۰ متر • ۳ دقیقه پیاده",
        tourist_dist_istiklal: "۲۰۰ متر • ۲.۵ دقیقه پیاده",
        tourist_dist_karakoy: "۶۰۰ متر • ۸ دقیقه سرازیری",
        tourist_badge_outlets: "⚡ پریز برق و شارژ کنار میزها",
        tourist_badge_luggage: "🧳 مناسب برای کوله‌پشتی و چمدان",
        ...
        text_group_events: "<strong>رویدادهای گروهی و خصوصی:</strong> برای رزروهای گروهی بعد از ساعت کاری و رویدادهای کوچک، لطفاً <a href='https://wa.me/905456301214?text=Hello,%20I%20would%20like%20information%20about%20group%20bookings. target='_blank' style='color:#059669; font-weight:700; text-decoration:underline;'>از طریق واتساپ تماس بگیرید</a>.",
        ...
        address_full: "<strong>آدرس:</strong> Şahkulu Mah. Kumbaracı Yokuşu Sok. No:41A, 34421 Beyoğlu/İstanbul (نزدیک خیابان استقلال و برج گالاتا)",
    ...
    it: {
        tourist_loc_badge: "📍 Nel Cuore di Galata",
        tourist_title: "A soli 3 minuti dalla Torre di Galata!",
        tourist_desc: "Prima o dopo la visita alla Torre di Galata e a via Istiklal, rilassatevi nel nostro edificio storico di 150 anni. Assaporate il celebre menemen Çakallı, una ricca colazione tradizionale turca e la verace pizza napoletana cotta nel forno a legna.",
        tourist_guide_link: "Itinerario Intelligente",
        tourist_dist_galata: "350m • 4 min a piedi",
        tourist_dist_sishane: "250m • 3 min a piedi",
        tourist_dist_istiklal: "200m • 2.5 min a piedi",
        tourist_dist_karakoy: "600m • 8 min in discesa",
        tourist_badge_outlets: "⚡ Prese e ricarica ai tavoli",
        tourist_badge_luggage: "🧳 Ideale per zaini e bagagli",

        category: "Caffetteria e ristorante",
        status_open: "Aperto ora (08:00 - 23:00)",
        btn_menu: "📖 Menu Digitale",
        btn_gezi: "🗺️ Guida turistica e percorso di Istanbul",
        btn_reserve: "Prenota un tavolo",
        btn_message: "Inviaci un messaggio",
        title_about: "Chi Siamo",
        slogan_about: "SAPORI DELLA TRADIZIONE, RICETTE UNICHE SOLO DA FIRINNA",
        text_about: "CARO OSPITE, BENVENUTO A FIRINNA.\n\nSituato nell'atmosfera storica di 150 anni di Galata, proprio sulla tranquilla Kumbaracı Yokuşu, il Fırınna Cafe & Restaurant è un paradiso culinario speciale dove puoi allontanarti dal trambusto di Istiklal Caddesi e fare una pausa rinfrescante.\n\nCon ingredienti accuratamente selezionati, specialità appena sfornate, ricche varietà di caffè e dolci fatti in casa, diamo vita alle ricette tradizionali con tocchi moderni.\n\nNon c'è fretta qui! Con il nostro team amichevole, ospitale e in cui sono ammessi gli animali domestici, goditi conversazioni calorose e momenti tranquilli nell'atmosfera del nostro edificio storico di 150 anni. Saremo lieti di essere un dolce ricordo del tuo storico viaggio a Istanbul.",
        title_top_reviews: "Dai nostri clienti",
        title_gating: "Valuta la tua esperienza",
        sub_gating: "Come è stata la tua esperienza a Firinna? Il tuo feedback significa molto per noi.",
        gating_high_msg: "🎉 Meraviglioso! Siamo lieti che ti sia piaciuto. Vorresti sostenerci con una recensione a 5 stelle su queste piattaforme?",
        gating_low_title: "Il tuo feedback è molto prezioso per noi!",
        gating_low_msg: "Puoi inviare qualsiasi feedback o problema direttamente al nostro manager:",
        btn_google_review: "Valuta 5 stelle su Google",
        btn_yandex_review: "Valuta su Yandex",
        btn_tripadvisor_review: "Recensione su TripAdvisor",
        google_perfect: "Eccellente su Google",
        yandex_perfect: "Ottimo su Yandex",
        btn_inspect: "Revisione",
        btn_see_all_google_photos: "Visualizza tutte le foto su Google Maps (oltre 100)",
        table_available: "Attualmente {N} tavoli disponibili, benvenuto!",
        table_full: "Attualmente tutti i tavoli sono occupati.",
        table_offline: "Stato della tabella non disponibile.",
        text_group_events: "<strong>Eventi privati ​​e di gruppo:</strong> per prenotazioni di gruppo e mini eventi fuori orario, <a href='https://wa.me/905456301214?text=Hello,%20I%20would%20like%20information%20about%20group%20bookings.' target='_blank' style='color:#059669; peso carattere: 700; text-decoration:underline;'>Contatto tramite WhatsApp</a>.",
        review_1: "Un posto meraviglioso e storico per sfuggire al rumore di Istiklal e prendere fiato. Le loro pizze sono leggendarie!",
        review_2: "Devi provare i menemen. Il personale è molto sorridente ed è fantastico che siano ammessi animali domestici.",
        review_3: "Il posto migliore a Galata per caffè e dessert. Il personale è molto attento.",
        title_virtual_tour: "Tour Virtuale (360°)",
        text_virtual_tour: "Esplora il nostro edificio storico di 150 anni proprio da dove ti siedi.",
        title_faq: "Domande Frequenti",
        faq_q1: "🐾 Sono ammessi animali domestici?",
        faq_a1: "SÌ! Fırınna accetta animali domestici al 100%. Puoi goderti il ​​tempo con i tuoi amici a quattro zampe sia nel nostro giardino all'aperto che nei posti a sedere al coperto.",
        faq_q2: "💳 Quali metodi di pagamento accettate?",
        faq_a2: "Accettiamo tutte le principali carte di credito, carte di debito, pagamenti mobili contactless (Apple Pay/Google Pay) e contanti.",
        faq_q3: "🥗 Avete opzioni Vegetariane o Senza Glutine?",
        faq_a3: "SÌ! Il nostro menu offre pizze vegetariane gourmet cotte nel forno a pietra, ricche colazioni e alternative senza glutine/vegane.",
        faq_q4: "🕒 Possiamo effettuare prenotazioni di gruppo o eventi privati?",
        faq_a4: "SÌ! Per compleanni, meeting aziendali o mini eventi privati, non esitate a contattarci direttamente tramite WhatsApp.",
        title_location: "Posizione",
        title_contact: "Contatto e posizione",
        title_gallery: "Atmosfera e sapori",
        gal_title_interior: "Interni e atmosfera",
        gal_title_exterior: "All'aperto e via Kumbaracı",
        gal_title_signature: "I nostri gusti caratteristici",
        gal_lbl_interior_history: "Interni storici",
        gal_lbl_warm_tables: "Posti a sedere accoglienti",
        gal_lbl_details: "Dettagli della sede",
        gal_lbl_street: "Via Kumbaraci",
        gal_lbl_outdoor_seating: "Posti a sedere all'aperto",
        gal_lbl_historic_building: "Edificio storico",
        gal_lbl_fresh_tea: "Tè turco fresco",
        gal_lbl_turkish_coffee: "Caffè Turco",
        gal_lbl_menemen: "Menemen della padella",
        gal_lbl_pizza: "Pizza al Forno a Legna",
        gal_lbl_lemonade: "Limonata Fatta in Casa",
        gal_lbl_glintwein: "Vin brulè",
        badge_historic_tr: "Storico caffè turco",
        badge_halal: "100% halal",
        badge_quality: "Migliore qualità",
        badge_price: "Prezzo giusto",
        title_reviews: "Posizione e recensioni recenti",
        btn_google: "Leggi le recensioni recenti di Google",
        btn_yandex: "Visualizza su Yandex Maps",
        btn_baidu: "Visualizza su Baidu Maps",
        modal_res_title: "Prenotazione tavolo",
        label_name: "Nome e cognome",
        label_phone: "Numero di telefono",
        label_date: "Data",
        label_time: "Orario (08:00-23:00)",
        label_guests: "Numero di ospiti",
        label_note: "Richiesta speciale/Nota (facoltativo)",
        btn_submit: "Invia richiesta",
        modal_msg_title: "Inviaci un messaggio",
        label_message: "Il tuo messaggio",
        btn_submit_msg: "Invia messaggio",
        footer_rights: "Tutti i diritti riservati.",
        menu_header_title: "Le Nostre Specialità",
        menu_header_sub: "Con il tocco di Firinna...",
        menu_back: "Casa",
        menu_intro: "Puoi visitare il nostro negozio o ottenere informazioni dettagliate dal nostro staff per tutte le opzioni di menu. Di seguito puoi rivedere i nostri gusti caratteristici più amati.",
        ...
        badge_veg: "Vegetariano",
        badge_vegan: "Vegano",
        badge_gluten: "Contiene glutine",
        badge_dairy: "Contiene latticini",
        title_work_hours: "Giorni e orari lavorativi",
        status_now_open: "🟢 Apri adesso",
        status_now_closed: "🔴 Chiuso adesso",
        signature_intro: "I nostri gusti più amati, accuratamente selezionati. Fare clic su qualsiasi elemento per visualizzare i dettagli del menu.",
        signature_loading: "Caricamento gusti caratteristici...",
        title_location_yandex: "Posizione e indicazioni (mappe Yandex)",
        badge_live_traffic: "🔴 Traffico in tempo reale ed edifici 3D",
        address_full: "<strong>Indirizzo:</strong> Şahkulu Mah. Kumbaracı Yokusu Sok. No:41A, 34421 Beyoğlu/İstanbul (vicino a Istiklal Street e alla Torre di Galata)",
        btn_yandex_nav: "Navigazione Yandex",
        btn_panorama: "Panorama a 360° della via Kumbaracı",
        title_social_media: "Cosa è popolare sui social media?",
        badge_tour_videos: "🎬 Video del tour e della preparazione",
        title_amenities: "Caratteristiche e servizi della sede",
        amenity_pet: "🐾 Pet friendly",
        amenity_halal: "🕌 Cibo 100% halal",
        amenity_wifi: "📶 Wi-Fi ad alta velocità gratuito",
        amenity_oven: "🍕 Forno Tradizionale in Pietra",
        amenity_historic: "🏛️ Atmosfera storica di 150 anni",
        amenity_nfc: "💳 Pagamento senza contatto/NFC",
        amenity_veg: "🌿 Opzioni Vegetariane",
        amenity_gluten: "🌾 Opzioni senza glutine/salutari",
        amenity_family: "👶 Adatto a famiglie e bambini",
        amenity_tea: "☕ Tè speciale alla miscela di boccioli di rosa",
        google_review_desc: "Visualizza tutte le recensioni e le valutazioni reali degli ospiti direttamente su Google.",
        yandex_review_desc: "Visualizza la posizione e rivedi i record su Yandex Maps.",
        badge_satisfaction: "Soddisfazione del cliente",
        title_social: "Responsabilità Sociale",
        social_intro: "Come Fırınna Cafe, condividiamo i nostri guadagni e il nostro amore con il nostro vicinato.",
        social_student_title: "Progetto studentesco a Beyoğlu",
        social_student_desc: "Supportiamo gli studenti universitari di Beyoğlu con pasti gratuiti.",
        social_animal_title: "Animali di strada amichevoli",
        social_animal_desc: "Ogni giorno forniamo cibo e acqua ai nostri amici a quattro zampe nella nostra strada.",
        search_placeholder: "🔍 Cerca nel menù...",
        filter_all: "✨Tutto il Menù",
        filter_halal: "☪️ 100% halal",
        filter_veggie: "🌿 Vegetariano",
        filter_glutenfree: "🌾Senza Glutine",
        filter_signature: "⭐Firma",
        badge_stone_oven: "🍕 Forno in pietra",
        title_pizza_napo: "Pizza Napoletana",
        badge_famous: "🍳 Famoso",
        title_menemen_cakal: "Menemen",
        badge_traditional: "☕ Tradizionale",
        title_coffee: "Caffè Turco",
        whatsapp_manager: "Gestore di WhatsApp",
        btn_send_msg2: "Invia messaggio",
        filter_dairyfree: "🚫 Senza latticini",
        cat_1: "Menemen",
        cat_2: "Omelette",
        cat_3: "Toast (Bazlama)",
        cat_4: "Pizze",
    ...
    el: {
        tourist_loc_badge: "📍 Στην Καρδιά του Γαλατά",
        tourist_title: "Μόνο 3 λεπτά από τον Πύργο του Γαλατά!",
        tourist_desc: "Πριν ή μετά την επίσκεψή σας στον ιστορικό Πύργο του Γαλατά και την οδό Istiklal. Το πλησιέστερο αυθεντικό σημείο στάσης για τους διάσημους Çakallı menemen, πλούσιο ανάμεικτο τουρκικό πρωινό και ναπολιτάνικη πίτσα με πέτρινο φούρνο με ξύλα στο ιστορικό κτήριο 150 ετών.",
        tourist_guide_link: "Διαδρομή Έξυπνης Πόλης",
        tourist_dist_galata: "350μ • 4 λεπτά περπάτημα",
        tourist_dist_sishane: "250μ • 3 λεπτά περπάτημα",
        tourist_dist_istiklal: "200μ • 2,5 λεπτά περπάτημα",
        tourist_dist_karakoy: "600μ • 8 λεπτά κατηφόρα",
        tourist_badge_outlets: "⚡ Πρίζα & φορτιστής σε τραπέζια",
        tourist_badge_luggage: "🧳 Φιλικό προς το σακίδιο και τη βαλίτσα",
        cat_1: "Μενεμέν",
        cat_2: "Ομελέτα",
        cat_3: "Μπαζλαμά (Τοστ)",
        cat_4: "Πίτσα",
        ...
        tag_vegan: "βίγκαν",
        tag_gluten: "Γλουτένη",
        tag_gluten_free: "χωρίς γλουτένη",
        tag_halal: "χαλάλι",
        tag_dairy: "Γαλακτοκομικά προϊόντα (καζεΐνη)",
        tag_vegetarian: "Χορτοφάγος",
        category: "Καφέ & Εστιατόριο",
        status_open: "Ανοιχτά τώρα (08:00 - 23:00)",
        btn_menu: "📖 Προβολή Ψηφιακού Μενού",
        btn_gezi: "🗺️ Ταξιδιωτικός οδηγός και διαδρομή Κωνσταντινούπολης",
        btn_reserve: "Κλείστε ένα τραπέζι τώρα",
        btn_message: "Αποστολή μηνύματος στον διαχειριστή (Telegram)",
        title_about: "Σχετικά με εμάς",
        slogan_about: "ΠΑΡΑΔΟΣΙΑΚΕΣ ΓΕΥΣΕΙΣ ΜΕ ΜΟΝΑΔΙΚΕΣ ΣΥΝΤΑΓΕΣ ΜΟΝΟ ΣΤΗ ΦΙΡΙΝΝΑ",
        text_about: "ΑΓΑΠΗΤΟΣ ΜΑΣ ΚΑΛΕΣΜΕΝΟΣ, ΚΑΛΩΣ ΟΡΙΣΑΤΕ ΣΤΗ ΦΙΡΙΝΑ.\n\nΤο Fırınna Cafe & Restaurant βρίσκεται στη συναρπαστική και ιστορική υφή του Γαλατά 150 ετών, στη γαλήνια ατμόσφαιρα του λόφου Kumbaracı. Είναι μια ξεχωριστή γευστική στάση όπου μπορείτε να ξεφύγετε από τον θόρυβο της Istiklal και να αναπνεύσετε.\n\nΠροσφέρουμε παραδοσιακές συνταγές με μοντέρνες πινελιές με τα προσεκτικά επιλεγμένα υλικά μας, φρέσκες γεύσεις από τον φούρνο μας, νόστιμες ποικιλίες καφέ και σπιτικά γλυκά.\n\nΧωρίς βιασύνη εδώ! Απολαύστε καλές συζητήσεις και γαλήνιες στιγμές στη ζεστασιά αυτού του ιστορικού κτιρίου 150 ετών με τη φιλική, φιλόξενη και φιλική προς τα κατοικίδια ομάδα μας. Είναι η μεγαλύτερη ευτυχία μας να μπορούμε να δημιουργήσουμε μια γλυκιά ανάμνηση στο ιστορικό ταξίδι σας στην Κωνσταντινούπολη.",
        title_top_reviews: "Από την οπτική των πελατών μας",
        title_gating: "Βαθμολογήστε την εμπειρία σας",
        sub_gating: "Πώς ήταν η εμπειρία σας στο Fırınna; Οι απόψεις σας είναι πολύτιμες για εμάς.",
        gating_high_msg: "🎉 Υπέροχα! Χαιρόμαστε πολύ που σας άρεσε. Θα θέλατε να μας υποστηρίξετε δίνοντάς μας μια κριτική 5 αστέρων στις παρακάτω πλατφόρμες;",
        gating_low_title: "Οι απόψεις σας είναι πολύτιμες για εμάς!",
        gating_low_msg: "Μπορείτε να προωθήσετε απευθείας το πρόβλημα ή την πρότασή σας στον υπεύθυνο της επιχείρησής μας:",
        btn_google_review: "Βαθμολογήστε με 5 αστέρια στο Google",
        btn_yandex_review: "Βαθμολογία στο Yandex",
        btn_tripadvisor_review: "Κριτική στο TripAdvisor",
        google_perfect: "Τέλεια στο Google",
        yandex_perfect: "Εξαιρετικό στο Yandex",
        btn_inspect: "Κριτική",
        btn_see_all_google_photos: "Δείτε όλες τις φωτογραφίες στους Χάρτες Google (100+)",
        table_available: "Αυτήν τη στιγμή έχουμε διαθέσιμα {N} τραπέζια, σας περιμένουμε!",
        table_full: "Όλα τα τραπέζια μας είναι γεμάτα τώρα.",
        table_offline: "Δεν ήταν δυνατή η ανάκτηση πληροφοριών κατάστασης πίνακα.",
        text_group_events: "<strong>Ομαδικές και ειδικές εκδηλώσεις:</strong> Για ομαδικές κρατήσεις εκτός ωραρίου και μίνι εκδηλώσεις <a href='https://wa.me/905456301214?text=Γεια σας, θέλω%20information%20about%20%20group%20reservation%20or%2'0evential%20or%20special. target='_blank' style='color:#059669; βάρος γραμματοσειράς:700; text-decoration:underline;'>Μπορείτε να επικοινωνήσετε μαζί μου στο WhatsApp</a>.",
        review_1: "Ένα υπέροχο, ιστορικό μέρος όπου μπορείτε να ξεφύγετε από τον θόρυβο του Istiklal και να αναπνεύσετε. Οι πίτσες τους είναι θρυλικές!",
        review_2: "Πρέπει να δοκιμάσετε το cakalli menemen. Το προσωπικό είναι πολύ φιλικό και είναι υπέροχο που είναι φιλικό προς τα κατοικίδια.",
        review_3: "Το καλύτερο μέρος για να πιείτε καφέ και να φάτε επιδόρπιο στο Γαλατά. Οι υπάλληλοι είναι πολύ προσεκτικοί.",
        title_virtual_tour: "Εικονική περιήγηση (360°)",
        text_virtual_tour: "Εξερευνήστε το ιστορικό κτήριο 150 ετών από εκεί που κάθεστε.",
        title_faq: "Συχνές Ερωτήσεις",
        faq_q1: "🐾 Δέχεστε κατοικίδια;",
        faq_a1: "Ναί! Το Fırınna είναι φιλικό προς τα κατοικίδια. Μπορείτε να απολαύσετε το χρόνο σας με τους χαριτωμένους φίλους σας στον κήπο μας και σε εσωτερικούς χώρους.",
        faq_q2: "💳 Ποιοι τρόποι πληρωμής είναι έγκυροι;",
        faq_a2: "Γίνονται δεκτές όλες οι εγχώριες και ξένες πιστωτικές κάρτες, χρεωστικές κάρτες, ανεπαφικές πληρωμές (Apple Pay / Google Pay) και μετρητά.",
        faq_q3: "🥗 Υπάρχουν επιλογές για χορτοφάγους / χωρίς γλουτένη;",
        faq_a3: "Ναί! Το μενού μας περιλαμβάνει ειδικές χορτοφαγικές πίτσες με πέτρινο φούρνο, πλούσια είδη πρωινού και εναλλακτικές επιλογές χωρίς γλουτένη/vegan.",
        faq_q4: "🕒 Μπορούμε να κάνουμε ομαδικές κρατήσεις ή ιδιωτικές εκδηλώσεις;",
        faq_a4: "Ναι, μπορείτε να επικοινωνήσετε μαζί μας απευθείας στη γραμμή WhatsApp για γενέθλια, συναντήσεις και ειδικούς μίνι οργανισμούς.",
        title_location: "τοποθεσία",
        title_contact: "Επικοινωνία & Μεταφορές",
        title_gallery: "Ατμόσφαιρα & Γεύσεις",
        gal_title_interior: "Εσωτερικό & Ατμόσφαιρα",
        gal_title_exterior: "Υπαίθριος & Λόφος Kumbaracı",
        gal_title_signature: "Οι Signature Γεύσεις μας",
        gal_lbl_interior_history: "Ιστορικό Εσωτερικό",
        gal_lbl_warm_tables: "Ζεστά Τραπέζια",
        gal_lbl_details: "Λεπτομέρειες Χώρου Διεξαγωγής",
        gal_lbl_street: "Λόφος Kumbaracı",
        gal_lbl_outdoor_seating: "Εξωτερικός χώρος τραπεζιού",
        gal_lbl_historic_building: "Ιστορικό Κτίριο",
        gal_lbl_fresh_tea: "Φρέσκο ​​Τσάι",
        gal_lbl_turkish_coffee: "Τουρκικός καφές",
        gal_lbl_menemen: "Παν Μενεμένη",
        gal_lbl_pizza: "Πίτσα Πέτρινου Φούρνου",
        gal_lbl_lemonade: "Σπιτική λεμονάδα",
        gal_lbl_glintwein: "Hot Glintwein",
        badge_historic_tr: "Ιστορικό Τουρκικό Καφενείο",
        badge_halal: "100% Χαλάλ",
        badge_quality: "Καλύτερη Ποιότητα",
        badge_price: "Προσιτή Τιμή",
        title_reviews: "Τοποθεσία & Τελευταία Σχόλια",
        btn_google: "Διαβάστε τις πιο πρόσφατες κριτικές στο Google",
        btn_yandex: "Εξερευνήστε στους Χάρτες Yandex",
        btn_baidu: "Κριτική για το Baidu (百度地图)",
        modal_res_title: "Κράτηση τραπεζιού",
        label_name: "Όνομα Επώνυμο",
        label_phone: "Τηλέφωνο",
        label_date: "Ιστορία",
        label_time: "Ώρα (08:00-23:00)",
        label_guests: "Αριθμός Ανθρώπων",
        label_note: "Ειδικό αίτημα/Σημείωση (Προαιρετικό)",
        btn_submit: "Υποβολή Αίτησης",
        modal_msg_title: "Στείλτε μας ένα μήνυμα",
        label_message: "Το μήνυμά σας",
        btn_submit_msg: "Αποστολή μηνύματος",
        footer_rights: "Με την επιφύλαξη παντός δικαιώματος.",
        menu_header_title: "Οι Signature Γεύσεις μας",
        menu_header_sub: "Με τις πινελιές του φούρνου...",
        menu_back: "Αρχική Σελίδα",
        menu_intro: "Μπορείτε να επισκεφτείτε το κατάστημά μας για όλες τις επιλογές του μενού μας ή να λάβετε αναλυτικές πληροφορίες από το προσωπικό μας. Μπορείτε να δείτε τις πιο δημοφιλείς γεύσεις με υπογραφή παρακάτω.",
        menu_download: "Λήψη μενού με τιμή (PDF)",
        ...
        cat_food: "Ζεστό από τον Φούρνο",
        cat_drinks: "Ποτά & Επιδόρπια",
        item_pizza: "Πίτσα Πέτρινου Φούρνου",
        desc_pizza: "Η ειδική μας ζύμη που έχει υποστεί ζύμωση μαγειρεύεται σε φωτιά με ξύλα με ιταλική σάλτσα ντομάτας και νόστιμο τυρί μοτσαρέλα.",
        item_menemen: "Διάσημος Cakalli Menemen",
        desc_menemen: "Ο θρύλος του πρωινού με την τοπική του γεύση, που παρασκευάζεται μόνο με κρόκο, πολύ τσένταρ και βούτυρο.",
        item_toast: "Ψημένο τοστ Bazlama",
        desc_toast: "Σερβίρεται τραγανό σε πέτρινο φούρνο με τυρί kashar και σπέσιαλ sucuk/kavrma, ανάμεσα σε χωριάτικο ψωμί.",
        item_coffee: "Ειδικός Τούρκικος Καφές",
        desc_coffee: "Ειδικά καβουρδισμένοι και αλεσμένοι, πιο ποιοτικοί φρέσκοι καφέδες Arabica στην πιο νόστιμη μορφή τους, συνοδευόμενοι από το περίφημο λουκούμι.",
        item_tea: "Τσάι με μείγμα Rosebud",
        desc_tea: "Παρασκευάζεται με περγαμόντο και αποξηραμένα μπουμπούκια τριαντάφυλλου στο πιο αποκλειστικό μείγμα τσαγιού Τουρκίας και Κεϋλάνης.",
        item_lemonade: "Σπιτική σπέσιαλ λεμονάδα",
        desc_lemonade: "Παγωμένη σπιτική φρέσκια λεμονάδα. Περιέχει επιπλέον ιβίσκο, κανέλα, αστεροειδή γλυκάνισο και περσικό σαφράν.",
        item_cake: "Ζεστό κέικ με σάλτσα σοκολάτας",
        desc_cake: "Απαραίτητη γεύση με απαλό εσωτερικό, άφθονο κακάο και καλυμμένο με ζεστή σάλτσα σοκολάτας.",
        badge_veg: "Χορτοφάγος",
        badge_vegan: "βίγκαν",
        badge_gluten: "Περιέχει γλουτένη",
        badge_dairy: "Γαλακτοκομικό Προϊόν",
        title_work_hours: "Εργάσιμες Ημέρες & Ώρες",
        status_now_open: "🟢 Ανοίξτε τώρα",
        status_now_closed: "🔴 Προς το παρόν κλειστό",
        signature_intro: "Οι πιο δημοφιλείς γεύσεις μας, προσεκτικά επιλεγμένες. Κάνοντας κλικ στο προϊόν που θέλετε να ελέγξετε, μπορείτε να μεταβείτε στις λεπτομέρειες του στο μενού.",
        signature_loading: "Οι υπογραφές γεύσεις φορτώνονται...",
        title_location_yandex: "Τοποθεσία και μεταφορές (Χάρτες Yandex)",
        badge_live_traffic: "🔴 Ζωντανή κυκλοφορία και τρισδιάστατα κτίρια",
        address_full: "<strong>Διεύθυνση:</strong> Şahkulu Mah. Kumbaracı Yokuşu St. No:41A, 34421 Beyoğlu/İstanbul (Κοντά στην οδό Istiklal & τον Πύργο του Γαλατά)",
        btn_yandex_nav: "Πλοήγηση Yandex",
        btn_panorama: "Πανόραμα λόφου Kumbaracı 360°",
        title_social_media: "Τι είναι το Famous στα Social Media;",
        badge_tour_videos: "🎬 Βίντεο περιήγησης και προετοιμασίας",
        title_amenities: "Χαρακτηριστικά & Εγκαταστάσεις Χώρου",
        amenity_pet: "🐾 Φιλικό προς τα Κατοικίδια",
        amenity_halal: "🕌 100% Φαγητό Χαλάλ",
        amenity_wifi: "📶 Δωρεάν Wi-Fi υψηλής ταχύτητας",
        amenity_oven: "🍕 Παραδοσιακός Πέτρινος Φούρνος",
        amenity_historic: "🏛️ 150 Χρόνια Ιστορικής Ατμόσφαιρας",
        amenity_nfc: "💳 Πληρωμή χωρίς επαφή / NFC",
        amenity_veg: "🌿 Εναλλακτικές για χορτοφάγους",
        amenity_gluten: "🌾 Χωρίς γλουτένη / Επιλογές Fit",
        amenity_family: "👶 Κατάλληλο για οικογένειες και παιδιά",
        amenity_tea: "☕ Special Blend Τσάι Τριαντάφυλλου",
        google_review_desc: "Δείτε όλες τις πραγματικές κριτικές και αξιολογήσεις επισκεπτών απευθείας στο Google.",
        yandex_review_desc: "Δείτε τις εγγραφές τοποθεσίας και βαθμολογίας στους Χάρτες Yandex.",
        badge_satisfaction: "Ικανοποίηση πελατών",
        title_social: "Κοινωνική Ευθύνη",
        social_intro: "Ως Fırınna Cafe, μετατρέπουμε τα κέρδη μας και όλες τις συμβουλές από εσάς απευθείας σε κοινωνικό όφελος.",
        social_student_title: "Έργο Beyoğlu To Students",
        social_student_desc: "Είμαστε περήφανοι υποστηρικτές του έργου To Students του Δήμου Beyoğlu. Παρέχουμε δωρεάν υποστήριξη γευμάτων στους φοιτητές μας.",
        social_animal_title: "Street Life Friendly",
        social_animal_desc: "Καλύπτουμε τα έξοδα φαγητού, νερού και κτηνιατρικών εξόδων των παπουτσιών μας στο δρόμο μας. Η επιχείρησή μας είναι απολύτως φιλική προς τα κατοικίδια.",
        search_placeholder: "🔍 Αναζητήστε γεύσεις στο μενού... (π.χ.: Menemen, Pizza)",
        filter_all: "✨ Μενού Όλα",
        filter_halal: "☪️ 100% Χαλάλ",
        filter_veggie: "🌿 Χορτοφάγος",
        filter_glutenfree: "🌾 Χωρίς γλουτένη / Fit",
        filter_signature: "⭐ Signature Flavors",
        badge_stone_oven: "🍕 Πέτρινος Φούρνος",
        title_pizza_napo: "Ναπολιτάνικη πίτσα",
        badge_famous: "🍳 Διάσημος",
        title_menemen_cakal: "Cakalli Menemen",
        badge_traditional: "☕ Παραδοσιακό",
        title_coffee: "Καβουρδισμένος τούρκικος καφές",
        whatsapp_manager: "WhatsApp Manager",
        btn_send_msg2: "Αποστολή μηνύματος",
        filter_dairyfree: "🚫 Χωρίς γάλα/καζεΐνη",
        p_c4: "Iced Americano",
        desc_c4: "Ο δροσιστικός συνδυασμός παγωμένου εσπρέσο και νερού, σερβιρισμένος με ειδικά μπισκότα κακάο.",
        p_c5: "Iced Latte",
        desc_c5: "Η αναζωογονητική αρμονία του παγωμένου φρέσκου γάλακτος και του εσπρέσο, σερβιρισμένο με ειδικά μπισκότα κακάο.",
    },
    ja: {
        tourist_loc_badge: "📍 ガラタの中心部",
        tourist_title: "ガラタ塔からわずか3分！",
        tourist_desc: "歴史的なガラタ塔とイスティクラル通りを訪れる前後。築150年の歴史ある建物内で、有名なチャカリ・メネメン、ボリュームのあるトルコ風ミックスブレックファスト、薪で焼いた石窯ナポリピザを楽しめる、最も近い本物のレストランです。",
        tourist_guide_link: "スマートシティルート",
        tourist_dist_galata: "350m・徒歩4分",
        tourist_dist_sishane: "250m・徒歩3分",
        tourist_dist_istiklal: "200m・徒歩2分半",
        tourist_dist_karakoy: "600m • 下り坂 8分",
        tourist_badge_outlets: "⚡ テーブル上のソケットと充電器",
        tourist_badge_luggage: "🧳 バックパックとスーツケースに優しい",
        cat_1: "メネメン (Menemen)",
        cat_2: "オムレツ",
        cat_3: "バズラマ (トースト)",
        cat_4: "ピザ",
        ...
        tag_vegan: "ビーガン",
        tag_gluten: "グルテン",
        tag_gluten_free: "グルテンフリー",
        tag_halal: "ハラール",
        tag_dairy: "乳製品（カゼイン）",
        tag_vegetarian: "ベジタリアン",
        category: "カフェ＆レストラン",
        status_open: "営業中 (08:00 - 23:00)",
        btn_menu: "📖 デジタルメニューを見る",
        btn_gezi: "🗺️ イスタンブールの旅行ガイドとルート",
        btn_reserve: "今すぐテーブルを予約する",
        btn_message: "マネージャーにメッセージを送信 (電報)",
        title_about: "私たちについて",
        slogan_about: "フィリンナだけのユニークなレシピによる伝統的な味",
        text_about: "親愛なるゲストの皆様、フィリンナへようこそ。\n\nFırınna Cafe & Restaurantは、150年の歴史を持つ魅力的で歴史的なガラタのクンバラシ丘の静かな雰囲気に位置しています。イスティクラルの喧騒から逃れて一息つける特別な味わいの場所です。\n\n厳選した食材、オーブンで淹れたての新鮮なフレーバー、おいしいコーヒー各種、自家製デザートを使用した伝統的なレシピに現代的なタッチを加えたものを提供しています。\n\nここで急ぐ必要はありません！築150年の歴史ある建物の温かさの中で、フレンドリーでおもてなしの心豊かなペットフレンドリーなチームと一緒に、楽しい会話と穏やかなひとときをお楽しみください。歴史的なイスタンブール旅行で素敵な思い出を作ることができれば、私たちにとってこの上ない幸せです。",
        title_top_reviews: "お客様の視点から",
        title_gating: "あなたの体験を評価してください",
        sub_gating: "フィルナ体験はどうでしたか？あなたの意見は私たちにとって非常に貴重です。",
        gating_high_msg: "🎉 素晴らしい！気に入っていただけてとても嬉しいです。以下のプラットフォームで 5 つ星のレビューを投稿して、私たちをサポートしませんか?",
        gating_low_title: "あなたの意見は私たちにとって非常に貴重です。",
        gating_low_msg: "問題や提案を当社のビジネス マネージャーに直接転送できます。",
        btn_google_review: "Google で 5 つ星を評価する",
        btn_yandex_review: "Yandex のレート",
        btn_tripadvisor_review: "トリップアドバイザーでのレビュー",
        google_perfect: "Google で完璧",
        yandex_perfect: "Yandexで優れています",
        btn_inspect: "レビュー",
        btn_see_all_google_photos: "Google マップ上のすべての写真を見る (100 枚以上)",
        table_available: "現在、{N} 個のテーブルが利用可能です。お待​​ちしています。",
        table_full: "現在テーブルはすべて満席です。",
        table_offline: "テーブルのステータス情報を取得できませんでした。",
        text_group_events: "<strong>グループ イベントと特別イベント:</strong> 営業時間外のグループ予約とミニ イベントの場合は、<a href='https://wa.me/905456301214?text=Hello, I want%20information%20about%20%20group%20reservation%20or%20special%20event%20' です。 target='_blank' style='color:#059669;フォントの太さ:700; text-decoration:underline;'>WhatsApp</a> でご連絡いただけます。",
        review_1: "イスティクラルの喧騒から逃れて深呼吸できる、歴史ある素晴らしい場所です。彼らのピザは伝説的です！",
        review_2: "カカリ・メネメンをぜひ試してみてください。スタッフはとてもフレンドリーで、ペットに優しいのは素晴らしいことです。",
        review_3: "ガラタでコーヒーを飲みながらデザートを食べるのに最適な場所。従業員はとても気が利いています。",
        title_virtual_tour: "バーチャルツアー (360°)",
        text_virtual_tour: "築150年の歴史ある建物を座ったまま探索してください。",
        title_faq: "よくある質問",
        faq_q1: "🐾 ペットを同伴できますか?",
        faq_a1: "はい！フィルナはペットを同伴できます。お庭や室内でかわいい仲間たちと楽しい時間をお過ごしいただけます。",
        faq_q2: "💳 どの支払い方法が有効ですか?",
        faq_a2: "国内外のクレジットカード、デビットカード、非接触型決済（Apple Pay / Google Pay）、現金がご利用いただけます。",
        faq_q3: "🥗 ベジタリアン/グルテンフリーのオプションはありますか?",
        faq_a3: "はい！メニューには、特別なベジタリアン石窯ピザ、豊富な朝食アイテム、グルテンフリー/ビーガンの代替品が含まれます。",
        faq_q4: "🕒 グループ予約やプライベートイベントを予約できますか?",
        faq_a4: "はい、誕生日、会議、特別なミニ組織については、WhatsApp ラインで直接ご連絡いただけます。",
        title_location: "位置",
        title_contact: "通信と輸送",
        title_gallery: "雰囲気と味",
        gal_title_interior: "内装・雰囲気",
        gal_title_exterior: "アウトドアとクンバラシの丘",
        gal_title_signature: "当社の代表的なフレーバー",
        gal_lbl_interior_history: "歴史あるインテリア",
        gal_lbl_warm_tables: "ホットテーブル",
        gal_lbl_details: "会場詳細",
        gal_lbl_street: "クンバラシの丘",
        gal_lbl_outdoor_seating: "テーブルエリア外",
        gal_lbl_historic_building: "歴史的建造物",
        gal_lbl_fresh_tea: "新茶",
        gal_lbl_turkish_coffee: "トルココーヒー",
        gal_lbl_menemen: "パン・メネメン",
        gal_lbl_pizza: "石窯ピザ",
        gal_lbl_lemonade: "自家製レモネード",
        gal_lbl_glintwein: "ホットグリントワイン",
        badge_historic_tr: "歴史あるトルコカフェ",
        badge_halal: "100%ハラール",
        badge_quality: "最高の品質",
        badge_price: "お手頃な価格",
        title_reviews: "場所と最新のコメント",
        btn_google: "Google で最新のレビューを読む",
        btn_yandex: "Yandex マップで探索する",
        btn_baidu: "Baidu (百度地图) のレビュー",
        modal_res_title: "テーブル予約",
        label_name: "名前 姓",
        label_phone: "電話",
        label_date: "歴史",
        label_time: "時間（08:00～23:00）",
        label_guests: "人数",
        label_note: "特別なリクエスト/メモ (オプション)",
        btn_submit: "リクエストの送信",
        modal_msg_title: "メッセージを送ってください",
        label_message: "あなたのメッセージ",
        btn_submit_msg: "メッセージを送信する",
        footer_rights: "無断転載を禁じます。",
        menu_header_title: "当社の代表的なフレーバー",
        menu_header_sub: "オーブンのタッチで...",
        menu_back: "ホームページ",
        menu_intro: "すべてのメニューオプションについては店舗にお越しいただくか、スタッフから詳しい情報を入手してください。最も人気のある代表的なフレーバーを以下でご確認いただけます。",
        menu_download: "料金メニューをダウンロード（PDF）",
        ...
        p_m1: "伝統的なメネメン",
        cat_food: "オーブンから出したばかりの熱々",
        cat_drinks: "ドリンク＆デザート",
        item_pizza: "石窯ピザ",
        desc_pizza: "特製の発酵生地を薪火で焼き上げ、イタリアントマトソースと美味しいモッツァレラチーズを加えて焼き上げました。",
        item_menemen: "有名なカカリ メネメン",
        desc_menemen: "卵黄、たっぷりのチェダーチーズ、バターだけを使った地元の味の伝説の朝食。",
        item_toast: "ベイクド・バズラマ・トースト",
        desc_toast: "カシャールチーズと特製のスクック/カヴルマを添えて石窯でカリカリに焼き上げ、村のパンに挟んでお召し上がりいただけます。",
        item_coffee: "特別なトルココーヒー",
        desc_coffee: "特別にローストして挽いた最高品質の新鮮なアラビカ種コーヒーを、最もおいしい形で、有名なターキッシュ デライトとともにお楽しみいただけます。",
        item_tea: "ローズバッドブレンドティー",
        desc_tea: "最も高級なトルコ茶とセイロン茶のブレンドにベルガモットと乾燥したバラのつぼみを加えて醸造されています。",
        item_lemonade: "自家製特製レモネード",
        desc_lemonade: "冷たい自家製フレッシュレモネード。ハイビスカス、シナモン、スターアニス、ペルシャサフランがたっぷり含まれています。",
        item_cake: "ホットケーキ チョコレートソース添え",
        desc_cake: "中はふんわり、カカオたっぷり、ホットチョコレートソースがかかった欠かせない味わいです。",
        badge_veg: "ベジタリアン",
        badge_vegan: "ビーガン",
        badge_gluten: "グルテンを含む",
        badge_dairy: "乳製品",
        title_work_hours: "営業日と営業時間",
        status_now_open: "🟢 今すぐオープン",
        status_now_closed: "🔴現在休業中",
        signature_intro: "当店一番人気のフレーバーを厳選しました。レビューしたい製品をクリックすると、メニューの詳細に移動できます。",
        signature_loading: "シグネチャーフレーバーを読み込み中...",
        title_location_yandex: "場所と交通手段 (Yandex Maps)",
        badge_live_traffic: "🔴 ライブ交通と 3D 建物",
        address_full: "<strong>Address:</strong> Şahkulu Mah. Kumbaracı Yokuşu St. No:41A, 34421 Beyoğlu/İstanbul (イスティクラル通りとガラタ塔の近く)",
        btn_yandex_nav: "Yandex ナビゲーション",
        btn_panorama: "360° クンバラシの丘のパノラマ",
        title_social_media: "ソーシャルメディアで有名なものは何ですか?",
        badge_tour_videos: "🎬 ツアーと準備ビデオ",
        title_amenities: "会場の特徴と設備",
        amenity_pet: "🐾 ペット可",
        amenity_halal: "🕌 100% ハラール食品",
        amenity_wifi: "📶無料高速Wi-Fi",
        amenity_oven: "🍕 伝統的な石窯",
        amenity_historic: "🏛️ 150年の歴史ある雰囲気",
        amenity_nfc: "💳非接触/NFC支払い",
        amenity_veg: "🌿 ベジタリアンの代替品",
        amenity_gluten: "🌾 グルテンフリー / フィットオプション",
        amenity_family: "👶 家族や子供に最適",
        amenity_tea: "☕ スペシャルブレンドローズティー",
        google_review_desc: "実際のゲストのレビューや評価をすべて Google で直接確認できます。",
        yandex_review_desc: "Yandex Maps で位置と評価の記録を確認します。",
        badge_satisfaction: "顧客満足度",
        title_social: "社会的責任",
        social_intro: "Fırınna Cafe として、私たちは収益と皆様からのすべてのヒントを社会的利益に直接変換します。",
        social_student_title: "ベイオール学生向けプロジェクト",
        social_student_desc: "私たちはベイオール市の学生向けプロジェクトを誇りに思っています。大学生への食事補助を無料で行っております。",
        social_animal_title: "ストリートライフに優しい",
        social_animal_desc: "私たちは、路上で暮らす肉友たちの食事、水、獣医の費用をまかなっています。私たちのビジネスは完全にペットフレンドリーです。",
        search_placeholder: "🔍 メニューでフレーバーを検索... (例: メネメン、ピザ)",
        filter_all: "✨全メニュー",
        filter_halal: "☪️ 100%ハラール",
        filter_veggie: "🌿 ベジタリアン",
        filter_glutenfree: "🌾 グルテンフリー / フィット",
        filter_signature: "⭐特製フレーバー",
        badge_stone_oven: "🍕 石窯",
        title_pizza_napo: "ナポリピッツァ",
        badge_famous: "🍳有名な",
        title_menemen_cakal: "カカリ・メネメン",
        badge_traditional: "☕ 伝統的",
        title_coffee: "ローストトルココーヒー",
        whatsapp_manager: "WhatsAppマネージャー",
        btn_send_msg2: "メッセージを送信する",
        filter_dairyfree: "🚫ミルク/カゼインフリー",
        p_c4: "アイスアメリカーノ",
        desc_c4: "アイスエスプレッソと水の爽やかな組み合わせに特製ココアクッキーを添えました。",
        p_c5: "アイスラテ",
        desc_c5: "アイスフレッシュミルクとエスプレッソの爽やかなハーモニーを特製ココアクッキーとともにお届けします。",
    }
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!initialLang) {
        ...
        else if (sysLang.startsWith('ja')) initialLang = 'ja';
        else if (sysLang.startsWith('el')) initialLang = 'el';
        else if (sysLang.startsWith('de')) initialLang = 'de';
        else if (sysLang.startsWith('fr')) initialLang = 'fr';
        else if (sysLang.startsWith('es')) initialLang = 'es';
        else if (sysLang.startsWith('it')) initialLang = 'it';
        else if (sysLang.startsWith('hi')) initialLang = 'hi';
        else if (sysLang.startsWith('fa')) initialLang = 'fa';
        else if (sysLang.startsWith('uk')) initialLang = 'uk';
...
const DAYS_I18N = {
    ...
    hi: { "Pazartesi": "सोमवार", "Salı": "मंगलवार", "Çarşamba": "बुधवार", "Perşembe": "गुरुवार", "Cuma": "शुक्रवार", "Cumartesi": "शनिवार", "Pazar": "रविवार" },
    el: { "Pazartesi": "Δευτέρα", "Salı": "Τρίτη", "Çarşamba": "Τετάρτη", "Perşembe": "Πέμπτη", "Cuma": "Παρασκευή", "Cumartesi": "Σάββατο", "Pazar": "Κυριακή" },
    ja: { "Pazartesi": "月曜日", "Salı": "火曜日", "Çarşamba": "水曜日", "Perşembe": "木曜日", "Cuma": "金曜日", "Cumartesi": "土曜日", "Pazar": "日曜日" }
};
...
const STATUS_I18N = {
    ...
    hi: { today: "(आज)", today_closed: "(आज - बंद)", closed: "बंद" },
    el: { today: "(Σήμερα)", today_closed: "(Σήμερα - Κλειστά)", closed: "Κλειστά" },
    ja: { today: "(今日)", today_closed: "(今日 - 閉店)", closed: "閉店" }
};
